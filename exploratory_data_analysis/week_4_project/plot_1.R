...
# get total PM2.5 emissions from 1999 to 2008

total_pm25_1999 <- sum(subset(NEI, year == 1999)$Emissions)
total_pm25_2002 <- sum(subset(NEI, year == 2002)$Emissions)
total_pm25_2005 <- sum(subset(NEI, year == 2005)$Emissions)
total_pm25_2008 <- sum(subset(NEI, year == 2008)$Emissions)
